...
private:
    ...
    QPen penV[4][3], penA[4][3];                    //строки - точки; столбцы - проекции

    Constants::SpeedStatus currentSpeedStatus[4];   //VO1, VA, VB, VC
    Constants::AccelStatus currentAccelStatus[4];   //AO1, AA, AB, AC
